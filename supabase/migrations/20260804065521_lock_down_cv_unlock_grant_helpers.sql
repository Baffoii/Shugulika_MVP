...
-- Client-facing wrappers: no default-public execute.
...
revoke all on function public.spend_cv_unlock(uuid, uuid) from public;
revoke all on function public.spend_cv_unlock(uuid, uuid) from anon;
