  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div>
          <label htmlFor="f-country" className="label-base">
            Country
          </label>
          <Select
            id="f-country"
        ...
        <div>
          <label htmlFor="f-type" className="label-base">
            Type
          </label>
          <Select
            id="f-type"
            defaultValue={params.get("employment_type") ?? ""}
        ...
        <div>
          <label htmlFor="f-arr" className="label-base">
            Workplace
          </label>
          <Select
            id="f-arr"
            defaultValue={params.get("work_arrangement") ?? ""}
            onChange={(e) => update({ work_arrangement: e.target.value })}
            className="mt-1"
          >
            <option value="">All</option>
        ...
        <div>
          <label htmlFor="f-exp" className="label-base">
            Level
          </label>
          <Select
            id="f-exp"
